...
/// User trades
/// </summary>
public record LighterUserTrades : LighterResponse
{
    /// <summary>
...
/// User trade
/// </summary>
public record LighterUserTrade
{
    /// <summary>
    ...
    /// <summary>
    /// ["<c>maker_allocated_margin_usdc_before</c>"] Maker allocated margin usdc before
    /// </summary>
    [JsonPropertyName("maker_allocated_margin_usdc_before")]
    public decimal? MakerAllocatedMarginUsdcBefore { get; set; }
    /// <summary>
    /// ["<c>maker_allocated_margin_usdc_after</c>"] Maker allocated margin usdc after
    /// </summary>
    [JsonPropertyName("maker_allocated_margin_usdc_after")]
    public decimal? MakerAllocatedMarginUsdcAfter { get; set; }
}
