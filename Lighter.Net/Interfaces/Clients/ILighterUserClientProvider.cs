namespace Lighter.Net.Interfaces.Clients
{
    ...
    /// </summary>
    public interface ILighterUserClientProvider
    {
        /// <summary>
        ...
        void InitializeUserClient(string userIdentifier, LighterCredentials credentials, LighterEnvironment? environment = null);
        ...
        /// <param name="environment">The environment to use</param>
        ILighterRestClient GetRestClient(string userIdentifier, LighterCredentials? credentials = null, LighterEnvironment? environment = null);
        ...
        /// <param name="credentials">The credentials for the user. Required the first time a client is requested for this user unless <see cref="InitializeUserClient" /> has been called prior for this user.</param>
        /// <param name="environment">The environment to use</param>
        ILighterSocketClient GetSocketClient(string userIdentifier, LighterCredentials? credentials = null, LighterEnvironment? environment = null);
    }
}